...
},
{
  ...
  en: [
    ...
    },
    {
      ...
      propertyTitle: "HOUSE + 2 CHALETS IN SERROTE — JERICOACOARA",
      location: "Beco do Serrote, Jericoacoara - CE",
      rating: 5,
      exclusiveText: "4 Units | House + 2 Chalets | 311 m² in the heart of Serrote | 300 m from Malhada Beach",
      summaryDescription: "Compound for sale on Beco do Serrote, the most prime area of Jericoacoara: a main house plus two chalets making up 4 accommodation units, fully furnished, set in a lush garden 300 meters from Malhada Beach and steps from Rua do Forró.",
      about: [
        "An address like this rarely comes up in Jericoacoara. This compound sits on Beco do Serrote — the village's most sought-after area —, just 300 meters from Malhada Beach and a few steps from Rua do Forró: all the energy of Jeri around you and, at the same time, the quiet of a garden wrapped in greenery.",
        "There are 4 independent accommodation units, spread across a main house and two chalets, joined by a mature, shaded garden with hammock corners, verandas and open-air lounging areas. Both chalets have their own kitchen and a wooden mezzanine; the main house has an upstairs suite and a ground-floor apartment with a separate kitchen.",
        "Everything is delivered furnished and ready to use, in Jeri's rustic-refined style — reclaimed wood, ceramic-tile roofs, handcrafted lighting and finishes that age well. An ideal setup to live in one unit and earn income from the others, or to run as a high-end boutique guesthouse.",
        "The lot is 311.81 m², with about 12.3 meters of frontage onto Beco do Serrote and roughly 25 meters of depth, and 191 m² of built area. The property also includes a laundry room, a linen closet, a barbecue area, a 5,000-liter cistern and two 2,000-liter water tanks.",
        "Paperwork is in order, with a registered topographic survey — legal security for a smooth purchase. Jericoacoara is one of the fastest-appreciating destinations on Brazil's coast, with direct flights from major cities to Jericoacoara Airport (JJD) and strong rental demand year-round. A scarce asset in an irreplaceable location."
      ],
      infra: [
        "311.81 m² lot (~12.3 m of frontage onto Beco do Serrote)",
        "191 m² of built area",
        "4 accommodation units: main house + 2 chalets",
        "2 chalets with kitchen and wooden mezzanine",
        "Upstairs suite in the main house",
        "Ground-floor apartment with a separate kitchen",
        "Laundry room and linen closet",
        "Barbecue area",
        "5,000-liter cistern + 2 water tanks of 2,000 liters",
        "Fully furnished (turnkey)",
        "Paperwork in order, with a registered topographic survey",
        "300 m from Malhada Beach and steps from Rua do Forró"
      ],
      facilities: ["311 m² Lot", "House + 2 Chalets", "4 Units", "Furnished", "300 m from Beach", "Serrote"],
      gallery: {
        main: '/imoveis/casa-2-chales-serrote-jericoacoara-01.webp',
        sideTop: '/imoveis/casa-2-chales-serrote-jericoacoara-02.webp',
        sideBottom: '/imoveis/casa-2-chales-serrote-jericoacoara-03.webp',
      ...
      mapImage: '/mapa.avif',
      mapUrl: 'https://maps.google.com/maps?q=-2.79371,-40.51372&hl=en&z=18&output=embed',
      videoSources: ['https://player.vimeo.com/video/1221853632', 'https://player.vimeo.com/video/1221856310'],
      documents: [
        {
          label: "Topographic Survey",
          url: "/documentos/casa-2-chales-serrote-jericoacoara-levantamento-topografico.pdf",
          legend: "Planimetric survey of the lot on Beco do Serrote, Jijoca de Jericoacoara — 311.81 m² and a 75.37 m perimeter."
        }
      ],
      priceTag: "Price",
      price: "R$ 2,500,000.00",
    ...
    },
    {
      ...
      summaryDescription: "High-end house in Praia do Preá, minutes from downtown, with 5 suites across two floors that can be used independently.",
      about: [
        "High-end house for sale in Praia do Preá, in a quiet location just minutes from downtown, with a privileged ocean view.",
        "5 suites spread across two floors that can be used independently, offering flexible living space with a cozy feel — ideal for large families or for hosting guests often.",
        "The in-house infrastructure, together with proximity to great restaurants and beach clubs in Preá, makes everyday life more practical, without long commutes."
      ],
      infra: [
        "5 suites across 2 independent floors",
        "739.56 m² built area",
        "1,734.10 m² total lot",
        "Minutes from downtown Preá",
        "Close to restaurants and beach clubs"
      ],
      facilities: ["5 Suites", "739m² Built", "1,734m² Lot", "Praia do Preá"],
    ...
    },
    {
      ...
      about: [
        "Considered one of the most spectacular homes in Preá, this exclusive villa offers a perfect blend of elegance, comfort, and privacy, located just a 7-minute walk from the beach. Designed for a refined yet relaxed lifestyle, it is ideal for families, hosting friends, or enjoying the world-renowned kitesurfing scene of the region.",
        "The property comfortably accommodates more than 10 guests, distributed across three independent apartments, featuring 4 private bedrooms, 4 full bathrooms, plus an additional fifth bathroom serving the pool and outdoor gourmet kitchen area.",
        "On the ground floor, there are two cozy one-bedroom studios, fully independent, each offering a queen-size bed, two additional single beds, a private bathroom, and a compact kitchen. The upper floor hosts a spacious two-bedroom apartment — primary with a king bed and second with a queen bed — a large living area, a sofa convertible into two extra single beds, two full bathrooms, and a functional kitchenette.",
        "The highlight of the property is the outdoor area, featuring a resort-style swimming pool and a fully equipped gourmet outdoor kitchen, ideal for social gatherings, plus a laundry area, extra bathroom, and generous storage space — all set within an architecture that favors indoor-outdoor integration, lush landscaping, and high-end finishes.",
        "Located in one of the most desirable areas of Preá, the property sits within a region that blends tranquility, preserved nature, and growing infrastructure — renowned restaurants, charming cafés, markets, schools, shops, and essential services, while keeping a pleasant residential feel and high quality of life.",
        "Preá is part of the Jericoacoara tourism hub, recognized for strong real estate appreciation, and sits about 15 minutes from Jericoacoara Regional Airport (JJD), with direct flights from major Brazilian cities — reinforcing the property's appeal for both residential use and investment."
      ],
      infra: [
        "Village house with 3 independent apartments (4 suites)",
        "5 full bathrooms",
        "220 m² built area on a 782.49 m² lot (14 x 55.9 m)",
        "New construction, completed December 2025",
        "5 parking spaces, 2 floors",
        "Resort-style pool and fully equipped outdoor gourmet kitchen",
        "Barbecue area and gourmet balcony",
        "Staff quarters and storage room",
        "Closet, air conditioning, and fiber-optic internet",
        "Pets allowed",
    ...
    },
    {
      ...
      slug: "casa-vila-9-bangalos-prea-gusso",
      title: "FOR SALE",
      searchTitle: "9-Bungalow Village House in Preá",
      image: "/imoveis/casa-vila-9-bangalos-prea-gusso-01.webp",
      badge: "Exclusive Opportunity",
      propertyTitle: "VILLAGE HOUSE WITH 9 BUNGALOWS IN PREÁ",
      location: "Preá, Cruz - CE",
      rating: 5,
      exclusiveText: "9 Independent Bungalows | 9 Suites | Pool | 1,151 m² Lot",
      summaryDescription: "Sophisticated village house with 9 independent bungalows in the heart of Preá, one block from Rancho do Peixe and Rancho do Kite, 250 meters from the beach.",
      about: [
        "A sophisticated village house composed of nine independent bungalows, located in the heart of Preá, just one block from Rancho do Peixe and Rancho do Kite.",
        "A rare property that combines regional identity, signature architecture, and a complete structure ready for immediate operation in one of the world's most sought-after kitesurfing destinations.",
        "Located in the heart of Preá, the property sits in one of the most valued areas on the Ceará coast. Just steps from the beach and neighboring iconic venues like Rancho do Peixe and Rancho do Kite, the surroundings combine discreet sophistication, preserved nature, and established tourist infrastructure.",
        "Preá is part of the Jericoacoara hub, an international destination known for its ideal wind conditions for much of the year, drawing European and South American visitors for water sports and experiential tourism.",
        "The region offers high-end restaurants, beach clubs, kitesurf schools, markets, pharmacies, and essential services, while retaining the rustic charm and exclusive atmosphere that keep driving up property values year after year. Easy access via Jericoacoara Regional Airport also boosts tourist flow and strengthens international occupancy potential — surroundings that balance nature, infrastructure, and continuous appreciation."
      ],
      infra: [
        "15 total rooms",
        "9 private suites",
        "10 full bathrooms",
        "525 m² of living area",
        "1,151.74 m² lot (25.9 x 45 m)",
        "Built in 2021",
        "250 meters from the beach",
        "Village house with 9 independent bungalows",
        "35 m² pool",
        "2-meter barbecue area",
        "Laundry room and storage",
        "32 kV diesel generator",
        "Artesian well and fiber-optic internet",
        "Furnished home with wood, stone, and concrete finishes",
        "Security camera system",
        "Large kitchen with built-in cabinets",
        "Garden, deck, and shared pool",
        "Porch, entrance hall, and large windows",
        "Gourmet space with adjoining dining area",
        "Electric water heating and cable TV",
        "Open views on a quiet residential street",
        "Minutes from Jericoacoara Regional Airport, schools, churches, and local shops"
      ],
      facilities: ["9 Bungalows", "9 Suites", "Pool", "1,151m² Lot", "250m to Beach"],
      gallery: {
        main: '/imoveis/casa-vila-9-bangalos-prea-gusso-01.webp',
        sideTop: '/imoveis/casa-vila-9-bangalos-prea-gusso-02.webp',
        sideBottom: '/imoveis/casa-vila-9-bangalos-prea-gusso-03.webp',
      ...
      mapImage: '/mapa.avif',
      mapUrl: 'https://maps.google.com/maps?q=Vila+Formosa,+Preá,+Cruz,+Ceará&hl=en&z=15&output=embed',
      videoSources: [],
      priceTag: "Price",
      price: "R$ 5,800,000.00",
      installments: "Consult conditions",
    ...
    },
    {
      ...
      location: "Farol do Itapajé - Itarema, CE",
      rating: 5,
      exclusiveText: "Exclusive area for sale. Total: R$ 4,000,000.00",
    ...
    },
    {
      ...
      slug: "terreno-barrinha-1840m2-matricula",
      title: "FOR SALE",
      searchTitle: "Barrinha 1,840m² Land with Registered Title",
      image: "/imoveis/terreno-barrinha-1840m2-matricula-01.webp",
      badge: "Rare Opportunity",
      propertyTitle: "BARRINHA LAND 1,840M² — REGISTERED TITLE & BANK FINANCING",
      location: "Barrinha, Acaraú - CE",
      rating: 5,
      exclusiveText: "1,840 sqm | Registered Title | Pre-Approved Bank Financing | 450m from Downtown",
      summaryDescription: "1,840 sqm land lot in Barrinha, 450m from downtown and 800m from the sea — with a registered title deed and pre-approved bank financing, a rare combination on the market.",
      about: [
        "Rare opportunity in Barrinha: a 1,840 sqm lot just 450 meters from downtown and 800 meters from the sea, in a strategic location between the beach and the area's urban infrastructure.",
        "The standout feature of this property is a level of legal and financial security rarely found on the market: the land has a registered title deed and comes with pre-approved bank financing, significantly speeding up the acquisition process for the buyer.",
        "An irregularly shaped lot with generous dimensions — 39.8 m and 25.3 m on its longest sides — ideal for developing a residential or hospitality project in one of the most promising regions of the Ceará coast."
      ],
      infra: [
        "Total area of 1,840 sqm",
        "Registered title deed",
        "Pre-approved bank financing",
        "450 meters from downtown",
        "800 meters from the sea",
        "Dimensions: 39.8 m / 31 m / 25.3 m / 23 m / 25.3 m / 3.6 m (irregular perimeter)"
      ],
      facilities: ["1,840 sqm", "Registered Title", "Pre-Approved Financing", "450m from Downtown"],
      gallery: {
        main: '/imoveis/terreno-barrinha-1840m2-matricula-01.webp',
        sideTop: '/imoveis/terreno-barrinha-1840m2-matricula-01.webp',
        sideBottom: '/imoveis/terreno-barrinha-1840m2-matricula-01.webp',
      ...
      mapImage: '/mapa.avif',
      mapUrl: 'https://maps.google.com/maps?q=Barrinha,+Acaraú+-+CE&hl=en&z=15&output=embed',
      videoSources: [],
      priceTag: "Price",
      price: "R$ 1,050,000.00",
      installments: "Consult conditions",
    ...
    },
    {
      ...
      location: "Preá, Cruz - CE",
      rating: 5,
      exclusiveText: "12 Houses | 3 Suites | 130m² | Starting at R$ 595,000.00 | Easy Financing",
      summaryDescription: "Residencial Jacarandá in Preá: 12 high-end houses with 3 suites, 130 sqm of built area, special bank financing conditions, and an easy down payment plan with the developer.",
      about: [
        "Residencial Jacarandá is an exclusive new release by Investimentos Imobiliários Preá Ltda., designed for those looking to realize the dream of owning a home on the Ceará coast — just 15 minutes from the Jericoacoara Airport and close to Lagun Beach Club.",
        "Only 12 houses on a quiet, no-through street, each with 3 suites with balcony, integrated dining and TV room, 1 social bathroom, garden area, private indoor garage, and gourmet balcony.",
        "The development offers three payment options: cash, direct financing with the developer (30% down + the rest in up to 12 interest-free installments), or bank financing — Residencial Jacarandá also qualifies for bracket 4 of the Minha Casa Minha Vida program."
      ],
      infra: [
        "Lots starting at 180 sqm",
        "130 sqm built area per unit",
        "3 suites with balcony",
        "1 social bathroom",
        "Integrated dining and TV room",
        "Garden area and gourmet balcony",
        "1 indoor garage spot per unit",
        "Only 12 houses, on a quiet no-through street",
        "Individual registered title per unit",
        "15 minutes from Jericoacoara Airport, close to Lagun Beach Club"
      ],
      facilities: ["3 Suites", "130m² Built", "180m² Lot", "12 Houses", "Easy Financing"],
      gallery: {
        main: '/imoveis/residencial-jacaranda-prea-01.webp',
        sideTop: '/imoveis/residencial-jacaranda-prea-02.webp',
        sideBottom: '/imoveis/residencial-jacaranda-prea-03.webp',
      ...
      documents: [
        {
          label: "Residencial Jacarandá Flyer",
          url: "/documentos/residencial-jacaranda-flyer.pdf",
          legend: "Floor plans, finishes, and payment conditions for the development."
        }
      ],
      priceTag: "Starting at",
      price: "R$ 595,000.00",
      installments: "30% down + 12 interest-free installments or bank financing",
      category: "lancamento"
    },
    {
      id: "15",
  ...
  },
    {
      ...
      location: 'Preá, Ceará, Brazil',
      rating: 5,
      exclusiveText: '2,200 sq.ft | 3 Bedrooms | 3 Bathrooms | 10 Exclusive Projects',
      ...
      about: [
        'Just steps from Preá\'s best kite spots, Vila do Inglês is an invitation to experience the Ceará coast on another level. 2,200 sq.ft built for everyday living: 3 bedrooms, 3 bathrooms, and generous spaces bathed in natural light from morning to night — the kind of home that turns any season into a permanent vacation.',
        'Floor-to-ceiling glass walls dissolve the line between indoors and out, opening the home to the greenery around it, while the private terrace guarantees a sunset all your own, with no neighbors in sight. Built to host with care, the home sleeps up to 8 comfortably: one bunk bedroom, two with double beds, plus two sofa beds — perfect for a big family, a group of friends, or as a high-performing seasonal rental.',
        'It\'s part of a select group of 10 exclusive projects in the region — opportunities like this don\'t stay available for long. If you\'re looking for a property that combines prime location, privacy, and appreciation potential on Brazil\'s fastest-growing coastline, Vila do Inglês is your entry point into this market. Talk to Terra Ventos and make it yours.',
      ],
      infra: ['Floor-to-ceiling glass walls', 'Private terrace', '3 bedrooms (1 bunk, 2 double) + 2 sofa beds', '3 modern bathrooms', 'Sleeps up to 8', 'Prime isolated location'],
  ...
  es: [
    ...
    },
    {
      ...
      propertyTitle: "CASA + 2 CHALÉS EN EL SERROTE — JERICOACOARA",
      location: "Beco do Serrote, Jericoacoara - CE",
      rating: 5,
      exclusiveText: "4 Unidades | Casa + 2 Chalés | 311 m² en el corazón del Serrote | 300 m de la Playa de Malhada",
      summaryDescription: "Conjunto en venta en el Beco do Serrote, la zona más noble de Jericoacoara: una casa principal y dos chalés que suman 4 unidades de alojamiento, totalmente amueblados, en un jardín exuberante a 300 metros de la Playa de Malhada y a pasos de la Rua do Forró.",
      about: [
        "Es raro que una dirección así quede disponible en Jericoacoara. Este conjunto está en el Beco do Serrote — la zona más valorada del pueblo —, a solo 300 metros de la Playa de Malhada y a pocos pasos de la Rua do Forró: toda la energía de Jeri alrededor y, al mismo tiempo, el silencio de un patio rodeado de vegetación.",
        "Son 4 unidades de alojamiento independientes, distribuidas en una casa principal y dos chalés, unidas por un jardín maduro y sombreado, con rincones de hamacas, galerías y estares al aire libre. Los dos chalés tienen cocina propia y altillo de madera; la casa principal reúne una suite en la planta superior y un apartamento en planta baja con cocina independiente.",
        "Todo se entrega amueblado y listo para usar, en el estilo rústico-sofisticado de Jeri — madera de demolición, teja cerámica, iluminación artesanal y acabados que envejecen bien. Una configuración ideal para vivir en una unidad y rentabilizar las demás, o para operar como posada boutique de alto nivel.",
        "El terreno tiene 311,81 m², con cerca de 12,3 metros de frente hacia el Beco do Serrote y aproximadamente 25 metros de fondo, y 191 m² de área construida. La propiedad cuenta además con lavandería, ropería, área de parrilla, cisterna de 5.000 litros y dos tanques de agua de 2.000 litros.",
        "La documentación está en regla, con levantamiento topográfico registrado — seguridad jurídica para una compra tranquila. Jericoacoara es uno de los destinos de mayor valorización del litoral brasileño, con vuelos directos desde las principales capitales al Aeropuerto de Jericoacoara (JJD) y fuerte demanda de alquiler todo el año. Un activo escaso, en una ubicación insustituible."
      ],
      infra: [
        "Terreno de 311,81 m² (frente de ~12,3 m hacia el Beco do Serrote)",
        "Área construida de 191 m²",
        "4 unidades de alojamiento: casa principal + 2 chalés",
        "2 chalés con cocina y altillo de madera",
        "Suite en la planta superior de la casa principal",
        "Apartamento en planta baja con cocina independiente",
        "Lavandería y ropería",
        "Área de parrilla",
        "Cisterna de 5.000 litros + 2 tanques de agua de 2.000 litros",
        "Totalmente amueblado (llave en mano)",
        "Documentación en regla, con levantamiento topográfico registrado",
        "A 300 m de la Playa de Malhada y a pasos de la Rua do Forró"
      ],
      facilities: ["311 m² de Terreno", "Casa + 2 Chalés", "4 Unidades", "Amueblado", "300 m de la Playa", "Serrote"],
      gallery: {
        main: '/imoveis/casa-2-chales-serrote-jericoacoara-01.webp',
        sideTop: '/imoveis/casa-2-chales-serrote-jericoacoara-02.webp',
        sideBottom: '/imoveis/casa-2-chales-serrote-jericoacoara-03.webp',
      ...
      mapImage: '/mapa.avif',
      mapUrl: 'https://maps.google.com/maps?q=-2.79371,-40.51372&hl=es&z=18&output=embed',
      videoSources: ['https://player.vimeo.com/video/1221853632', 'https://player.vimeo.com/video/1221856310'],
      documents: [
        {
          label: "Levantamiento Topográfico",
          url: "/documentos/casa-2-chales-serrote-jericoacoara-levantamento-topografico.pdf",
          legend: "Levantamiento planimétrico del terreno en el Beco do Serrote, Jijoca de Jericoacoara — 311,81 m² y perímetro de 75,37 m."
        }
      ],
      priceTag: "Valor",
      price: "R$ 2.500.000,00",
    ...
    },
    {
      ...
      rating: 5,
      exclusiveText: "5 Suites | Dos Pisos Independientes | 1.734 m² de Terreno",
      summaryDescription: "Casa de alto nivel en Praia do Preá, a pocos minutos del centro, con 5 suites distribuidas en dos pisos que pueden usarse de forma independiente.",
      about: [
        "Casa de alto nivel en venta en Praia do Preá, en ubicación tranquila y a pocos minutos del centro, con vista privilegiada al mar.",
        "Son 5 suites distribuidas en dos pisos que pueden usarse de forma independiente, ofreciendo flexibilidad de espacio junto con una sensación acogedora — ideal para familias grandes o para quienes reciben invitados con frecuencia.",
        "La infraestructura interna, sumada a la proximidad con buenos restaurantes y beach clubs del Preá, hace el día a día más práctico, sin necesidad de grandes desplazamientos."
      ],
      infra: [
        "5 suites distribuidas en 2 pisos independientes",
        "Área construida de 739,56 m²",
        "Terreno total de 1.734,10 m²",
        "A pocos minutos del centro del Preá",
        "Cerca de restaurantes y beach clubs"
      ],
      facilities: ["5 Suites", "739m² Construidos", "1.734m² de Terreno", "Praia do Preá"],
      gallery: {
    ...
    },
    {
      ...
      about: [
        "Considerada una de las casas más espectaculares del Preá, esta vila exclusiva combina sofisticación, confort y privacidad, a solo 7 minutos a pie de la playa. Diseñada para un estilo de vida elegante y relajado, es ideal para familias, para recibir amigos o para quienes valoran el lifestyle del kitesurf en una de las regiones más deseadas de Ceará.",
        "La propiedad acomoda cómodamente a más de 10 personas, distribuidas en tres apartamentos independientes, con 4 dormitorios privativos, 4 baños completos y un quinto baño de apoyo junto a la piscina y a la cocina gourmet exterior.",
        "En la planta baja, dos acogedores estudios de un dormitorio, totalmente independientes, cada uno con cama queen-size, dos camas individuales adicionales, baño privado y cocina compacta. En el piso superior, un amplio y luminoso apartamento con dos dormitorios — uno con cama king y otro con cama queen —, sala de estar amplia, sofá convertible en dos camas extra, dos baños completos y kitchenette.",
        "El gran diferencial es el área externa, con piscina estilo resort y una cocina gourmet al aire libre totalmente equipada, ideal para reuniones. La casa cuenta además con lavandería, baño adicional, amplio espacio de almacenamiento y una arquitectura que privilegia la integración entre ambientes internos y externos, con paisajismo exuberante y acabados de alto nivel.",
        "Ubicada en una de las áreas más valorizadas del Preá, la propiedad está inserta en un entorno que combina tranquilidad, naturaleza preservada y excelente infraestructura — restaurantes reconocidos, cafés encantadores, mercados, escuelas, tiendas y servicios esenciales, manteniendo un ambiente residencial agradable y una excelente calidad de vida.",
        "El Preá forma parte del polo turístico de Jericoacoara, reconocido por su fuerte crecimiento inmobiliario y alto potencial de valorización, y está a aproximadamente 15 minutos del Aeropuerto Regional de Jericoacoara (JJD), con vuelos directos desde las principales capitales de Brasil — fortaleciendo el potencial del inmueble tanto para uso residencial como para inversión."
      ],
      infra: [
        "Casa de vila con 3 apartamentos independientes (4 suites)",
        "5 baños completos",
        "Área construida de 220 m² en terreno de 782,49 m² (lote 14 x 55,9 m)",
        "Construcción nueva, finalizada en diciembre de 2025",
        "5 plazas de estacionamiento, 2 pisos",
        "Piscina estilo resort y cocina gourmet exterior equipada",
        "Parrilla y balcón gourmet",
        "Dependencia de servicio y depósito",
        "Closet, aire acondicionado e internet por fibra óptica",
    ...
    },
    {
      ...
      slug: "casa-vila-9-bangalos-prea-gusso",
      title: "VENTA",
      searchTitle: "Casa de Vila con 9 Bungalós en Preá",
      image: "/imoveis/casa-vila-9-bangalos-prea-gusso-01.webp",
      badge: "Oportunidad Exclusiva",
      propertyTitle: "CASA DE VILA CON 9 BUNGALÓS EN PREÁ",
      location: "Preá, Cruz - CE",
      rating: 5,
      exclusiveText: "9 Bungalós Independientes | 9 Suites | Piscina | 1.151 m² de Terreno",
      summaryDescription: "Sofisticada casa de vila con 9 bungalós independientes en el corazón del Preá, a una cuadra del Rancho do Peixe y del Rancho do Kite, a 250 metros de la playa.",
      about: [
        "Una sofisticada casa de vila compuesta por nueve bungalós independientes, ubicada en el corazón del Preá, a solo una cuadra del Rancho do Peixe y del Rancho do Kite.",
        "Un inmueble raro que combina identidad regional, arquitectura de autor y estructura completa para operación inmediata en uno de los destinos más valorizados del kitesurf mundial.",
        "Ubicado en el corazón del Preá, el inmueble se encuentra en una de las áreas más valorizadas del litoral de Ceará. A pocos pasos de la playa y vecino de emprendimientos icónicos como Rancho do Peixe y Rancho do Kite, el entorno combina sofisticación discreta, naturaleza preservada e infraestructura turística consolidada.",
        "El Preá integra el polo de Jericoacoara, destino internacional conocido por sus condiciones ideales de viento durante gran parte del año, atrayendo público europeo y sudamericano para deportes náuticos y turismo de experiencia.",
        "La región cuenta con restaurantes de alto nivel, beach clubs, escuelas de kitesurf, mercados, farmacias y servicios esenciales, manteniendo al mismo tiempo el encanto rústico y la atmósfera exclusiva que valorizan el metro cuadrado año tras año. Además, el acceso facilitado por el Aeropuerto Regional de Jericoacoara impulsa el flujo turístico y fortalece el potencial de ocupación internacional — un entorno que equilibra naturaleza, infraestructura y valorización continua."
      ],
      infra: [
        "15 ambientes en total",
        "9 suites privativas",
        "10 baños completos",
        "525 m² de área útil",
        "Terreno de 1.151,74 m² (lote de 25,9 x 45 m)",
        "Construcción de 2021",
        "250 metros de la playa",
        "Casa de vila con 9 bungalós independientes",
        "Piscina de 35 m²",
        "Parrilla de 2 metros",
        "Lavandería y depósito",
        "Generador a diésel de 32 kV",
        "Pozo artesiano e internet por fibra óptica",
        "Casa amueblada, con acabados en madera, piedra y concreto",
        "Circuito de cámaras de seguridad",
        "Cocina grande con armarios empotrados",
        "Jardín, deck y piscina colectiva",
        "Balcón, hall de entrada y ventanas amplias",
        "Espacio gourmet con comedor integrado",
        "Calefacción eléctrica y TV por cable",
        "Vista abierta, en calle residencial tranquila",
        "A pocos minutos del Aeropuerto Regional de Jericoacoara, escuelas, iglesias y comercios locales"
      ],
      facilities: ["9 Bungalós", "9 Suites", "Piscina", "1.151m² de Terreno", "250m de la Playa"],
      gallery: {
        main: '/imoveis/casa-vila-9-bangalos-prea-gusso-01.webp',
        sideTop: '/imoveis/casa-vila-9-bangalos-prea-gusso-02.webp',
        sideBottom: '/imoveis/casa-vila-9-bangalos-prea-gusso-03.webp',
      ...
      mapImage: '/mapa.avif',
      mapUrl: 'https://maps.google.com/maps?q=Vila+Formosa,+Preá,+Cruz,+Ceará&hl=es&z=15&output=embed',
      videoSources: [],
      priceTag: "Valor",
      price: "R$ 5.800.000,00",
      installments: "Consulte condiciones",
    ...
    },
    {
      ...
      location: "Farol do Itapajé - Itarema, CE",
      rating: 5,
      exclusiveText: "Área exclusiva en venta. Total: R$ 4.000.000,00",
    ...
    },
    {
      ...
      slug: "terreno-barrinha-1840m2-matricula",
      title: "VENTA",
      searchTitle: "Terreno Barrinha 1.840m² con Matrícula",
      image: "/imoveis/terreno-barrinha-1840m2-matricula-01.webp",
      badge: "Oportunidad Rara",
      propertyTitle: "TERRENO BARRINHA 1.840M² — MATRÍCULA Y FINANCIACIÓN BANCARIA",
      location: "Barrinha, Acaraú - CE",
      rating: 5,
      exclusiveText: "1.840 m² | Matrícula Registrada | Financiación Bancaria Pre-Aprobada | 450m del Centro",
      summaryDescription: "Terreno de 1.840 m² en Barrinha, a 450m del centro y 800m del mar — con matrícula registrada y financiación bancaria pre-aprobada, una combinación rara en el mercado.",
      about: [
        "Oportunidad rara en Barrinha: terreno de 1.840 m², a solo 450 metros del centro y 800 metros del mar, en ubicación estratégica entre la playa y la infraestructura urbana de la región.",
        "El gran diferencial de este inmueble es la seguridad jurídica y financiera raramente encontrada en el mercado: el terreno cuenta con matrícula registrada en notaría y financiación bancaria pre-aprobada, agilizando significativamente el proceso de adquisición para el comprador.",
        "Un terreno de contorno irregular y generosas dimensiones — 39,8 m y 25,3 m en sus lados más largos — ideal para el desarrollo de un proyecto residencial o de hospedaje en una de las regiones más prometedoras del litoral de Ceará."
      ],
      infra: [
        "Área total de 1.840 m²",
        "Matrícula registrada en notaría",
        "Financiación bancaria pre-aprobada",
        "A 450 metros del centro",
        "A 800 metros del mar",
        "Dimensiones: 39,8 m / 31 m / 25,3 m / 23 m / 25,3 m / 3,6 m (perímetro irregular)"
      ],
      facilities: ["1.840 m²", "Matrícula Registrada", "Financiación Pre-Aprobada", "450m del Centro"],
      gallery: {
        main: '/imoveis/terreno-barrinha-1840m2-matricula-01.webp',
        sideTop: '/imoveis/terreno-barrinha-1840m2-matricula-01.webp',
        sideBottom: '/imoveis/terreno-barrinha-1840m2-matricula-01.webp',
      ...
      mapImage: '/mapa.avif',
      mapUrl: 'https://maps.google.com/maps?q=Barrinha,+Acaraú+-+CE&hl=es&z=15&output=embed',
      videoSources: [],
      priceTag: "Valor",
      price: "R$ 1.050.000,00",
      installments: "Consulte condiciones",
    ...
    },
    {
      ...
      location: "Preá, Cruz - CE",
      rating: 5,
      exclusiveText: "12 Casas | 3 Suites | 130m² | Desde R$ 595.000,00 | Financiación Facilitada",
      summaryDescription: "Residencial Jacarandá en Preá: 12 casas de alto nivel con 3 suites, 130 m² de área construida, condiciones especiales de financiación bancaria y entrada facilitada con la constructora.",
      about: [
        "Residencial Jacarandá es un lanzamiento exclusivo de Investimentos Imobiliários Preá Ltda., pensado para quienes quieren realizar el sueño de la casa propia en el litoral de Ceará — a solo 15 minutos del Aeropuerto de Jericoacoara y cerca del Lagun Beach Club.",
        "Son solo 12 casas en una calle tranquila y sin salida, cada una con 3 suites con balcón, sala de comedor y TV integradas, 1 baño social, área de jardín, garaje interno privativo y balcón gourmet.",
        "El emprendimiento ofrece tres formas de pago: al contado, financiación directa con la constructora (30% de entrada + el resto en hasta 12 cuotas sin intereses) o financiación bancaria — Residencial Jacarandá también se encuadra en la franja 4 del programa Minha Casa Minha Vida."
      ],
      infra: [
        "Lotes desde 180 m²",
        "Área construida de 130 m² por unidad",
        "3 suites con balcón",
        "1 baño social",
        "Sala de comedor y TV integradas",
        "Área de jardín y balcón gourmet",
        "1 plaza de garaje interna por unidad",
        "Solo 12 casas, en calle tranquila y sin salida",
        "Matrícula individual por unidad",
        "A 15 minutos del Aeropuerto de Jericoacoara, cerca del Lagun Beach Club"
      ],
      facilities: ["3 Suites", "130m² Construidos", "180m² de Lote", "12 Casas", "Financiación Facilitada"],
      gallery: {
        main: '/imoveis/residencial-jacaranda-prea-01.webp',
        sideTop: '/imoveis/residencial-jacaranda-prea-02.webp',
        sideBottom: '/imoveis/residencial-jacaranda-prea-03.webp',
      ...
      documents: [
        {
          label: "Flyer Residencial Jacarandá",
          url: "/documentos/residencial-jacaranda-flyer.pdf",
          legend: "Plantas, acabados y condiciones de pago del emprendimiento."
        }
      ],
      priceTag: "Desde",
      price: "R$ 595.000,00",
      installments: "Entrada del 30% + 12 cuotas sin intereses o financiación bancaria",
      category: "lancamento"
    },
    {
      id: "15",
  ...
  },
    {
      ...
      location: 'Preá, Ceará, Brasil',
      rating: 5,
      exclusiveText: '2.200 sq.ft | 3 Habitaciones | 3 Baños | 10 Proyectos Exclusivos',
      ...
      about: [
        'A pocos pasos de los mejores spots de kite de Preá, Vila do Inglês es una invitación a vivir la costa de Ceará en otro nivel. Son 2.200 sq.ft pensados para el día a día: 3 habitaciones, 3 baños y ambientes amplios, bañados de luz natural de la mañana a la noche — el tipo de casa que convierte cualquier temporada en vacaciones permanentes.',
        'Las paredes de vidrio del suelo al techo disuelven la frontera entre el interior y el exterior, abriendo la casa al verde que la rodea, mientras la terraza privada garantiza un atardecer solo para ti, sin vecinos cerca. Hecha para recibir con cariño, la casa acomoda hasta 8 personas con comodidad: una habitación con litera, dos con cama matrimonial y dos sofás cama más — perfecta para una familia grande, un grupo de amigos o como alquiler de temporada de alto rendimiento.',
        'Forma parte de un grupo selecto de 10 proyectos exclusivos en la región — oportunidades así no permanecen disponibles por mucho tiempo. Si buscas una propiedad que combine ubicación premium, privacidad y potencial de valorización en la costa que más crece de Brasil, Vila do Inglês es tu puerta de entrada a este mercado. Habla con Terra Ventos y hazla tuya.',
      ],
      infra: ['Paredes de vidrio del suelo al techo', 'Terraza privada', '3 habitaciones (1 litera, 2 matrimoniales) + 2 sofás cama', '3 baños modernos', 'Capacidad para 8 personas', 'Ubicación prime aislada'],

...
export const oportunidadesDataByLang: Record<string, Partial<OportunidadeDetalhe>[]> = {
  pt: [
    ...
    {
      id: '03',
      slug: 'vila-do-ingles', category: 'temporada',
      title: 'TEMPORADA',
...
},
{
  ...
  en: [
  ...
  },
    {
      ...
      infra: [
        'Private pool',
        '2,000 sqm of land, fully private',
        'Sports court with beach tennis net',
        'Gourmet area with barbecue',
        'Natural garden and outdoor shower',
        'Air conditioning in every bedroom',
        'Smoke detector',
        'Farmhouse kitchen (dishwasher, washing machine, blender, toaster, coffee maker)',
        'Free-range chicken eggs',
        'Kite storage',
        'Parking for 5 cars',
        'Cook and cleaning service available separately'
      ],
      facilities: ['Private Pool', 'Air conditioning', 'Gourmet Area', 'Barbecue', 'Sports Court', 'Kite Storage', 'Parking', 'Smoke Detector'],
      gallery: {
        main: '/imoveis/vila-do-ingles-02.webp',
        sideTop: '/imoveis/vila-do-ingles-03.webp',
        sideBottom: '/imoveis/vila-do-ingles-04.webp',
  ...
  es: [
  ...
  },
    {
      ...
      infra: [
        'Piscina privada',
        '2.000 m² de terreno, 100% privado',
        'Cancha deportiva con red de beach tennis',
        'Área gourmet con parrilla',
        'Jardín natural y ducha al aire libre',
        'Aire acondicionado en todas las habitaciones',
        'Detector de humo',
        'Cocina de granja (lavavajillas, lavadora, licuadora, tostadora, cafetera)',
        'Huevos de gallinas en libertad',
        'Guardado para kite',
        'Estacionamiento para 5 autos',
        'Cocinera y limpieza disponibles por separado'
      ],
      facilities: ['Piscina Privada', 'Aire acondicionado', 'Área Gourmet', 'Parrilla', 'Cancha Deportiva', 'Guardado de Kite', 'Estacionamiento', 'Detector de Humo'],
      gallery: {
        main: '/imoveis/vila-do-ingles-02.webp',
        sideTop: '/imoveis/vila-do-ingles-03.webp',
        sideBottom: '/imoveis/vila-do-ingles-04.webp',
